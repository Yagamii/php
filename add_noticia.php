<?php
	...
	if(isset($_POST['enviado'])){
		...
		if(empty($erros)){
			$q = "INSERT INTO noticias (titulo, corpo, data_noticia, categoria_id, usuario_id) VALUES ('$titulo', '$corpo', NOW(), '$categoria', '$autor')";
	...
	echo '<h1 align="center">Adicionar notícia</h1>
		...
		<div align="center"><form name="addMateria" action="add_noticia.php" method="post">
			<table border="0">
    	<tr>
        	<td><p>Título:</p></td>
        ...
        <tr>
            ...
            <td><p align="left"><select name="categoria">';
            		...
            		$q = "SELECT * FROM categorias ORDER BY nome ASC";
					$r = mysqli_query($dbc, $q);
